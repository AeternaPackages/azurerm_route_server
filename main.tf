...
module "route_servers" {
  source        = "git::https://github.com/AeternaModules/azurerm_route_server.git?ref=v5.0.0"
  route_servers = local.route_servers
}

module "route_server_bgp_connections" {
  source                       = "git::https://github.com/AeternaModules/azurerm_route_server_bgp_connection.git?ref=v5.0.0"
